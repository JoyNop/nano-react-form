    ...
    render() {
        ...
        return (
            <React.Fragment>
                ...
                <div style={{ marginBottom: '15px' }}>
                    <p style={{ marginBottom: '5px' }}>选项：<Icon type="plus-circle"  title="添加" style={{ cursor: 'pointer', color: 'greed' }}
                        onClick={() => {
                            ...
                            options.options.map((el:any, i:number) =>
                                <Radio style={radioStyle} value={el.value}>
                                    <div key={i} style={{ marginBottom: '3px', display: 'inline' }}>
                                        ...
                                        />
                                        <Icon type="minus-circle"  title="删除" style={{ cursor: 'pointer', color: 'red', marginLeft: '10px' }}
                                            onClick={() => {
                                                let _options = options.options
                                                _options.splice(i, 1)
                                                this.props.callback('options', _options)
